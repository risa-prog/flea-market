...
<div class="address-form">
    <form action="{{ route('edit', ['item_id' => $item_id]) }}" method="post">
        @method('patch')
        @csrf
        ...
        <div class="address-form__group">
            ...
            <div class="address-form__item">
                <input class="address-form__input" type="text" name="post_code" value="{{ old('post_code', $member['post_code']) }}">
            </div>
        ...
        <div class="address-form__group">
            ...
            <div class="address-form__item">
                <input class="address-form__input" type="text" name="address" value="{{ old('address', $member['address']) }}">
            </div>
            <div class="address-form__error">
                @error('address')
                <p class="address-form__error-message">{{ $message }}</p>
        ...
        <div class="address-form__group">
            ...
            <div class="address-form__item">
                <input class="address-form__input" type="text" name="building" value="{{ old('building', $member['building']) }}">
            </div>
            <div class="address-form__error">
                @error('building')
                <p class="address-form__error-message">{{$message}}</p>
